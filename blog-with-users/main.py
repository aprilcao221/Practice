...
def register():
    ...
    if request.method == "POST":
        ...
        if user:
            ...
            psw_hashed = generate_password_hash(form.password.data, "pbkdf2", salt_length=8)
            print(psw_hashed)
            new_user = User(
                name=form.name.data,
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, logged_in=logged_in, form=form, all_comments=comments)
